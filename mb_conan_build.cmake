...
if( CONAN_EXPORTED OR MB_SKIP_CONAN_INSTALL )
    ...
    remote_include( "conan.cmake" "http://raw.githubusercontent.com/microblink/cmake-conan/v0.18.1/conan.cmake" "http://files.microblink.com/conan.cmake" )
    ...
    elseif( CMAKE_SYSTEM_NAME STREQUAL "Linux" )
        ...
        if ( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" )
            if ( NOT DEFINED MB_INTEL_OPTIMIZATION )
                set( MB_INTEL_OPTIMIZATION "haswell" )
            endif()
    ...
    if ( HAVE_PROFILE )
        ...
        # this also allows overwriting build_type from command line, instead of using values from profile
